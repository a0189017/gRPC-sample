...
var file_calculator_proto_rawDesc = []byte{
	...
	0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x32, 0x5d, 0x0a,
	0x11, 0x43, 0x61, 0x6c, 0x63, 0x75, 0x6c, 0x61, 0x74, 0x6f, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69,
	0x63, 0x65, 0x12, 0x48, 0x0a, 0x05, 0x54, 0x6f, 0x74, 0x61, 0x6c, 0x12, 0x1d, 0x2e, 0x63, 0x61,
...
var file_calculator_proto_depIdxs = []int32{
	0, // 0: calculator.CalculatorService.Total:input_type -> calculator.CalculatorRequest
	1, // 1: calculator.CalculatorService.Total:output_type -> calculator.CalculatorResponse
...
type CalculatorServiceClient interface {
	Total(ctx context.Context, in *CalculatorRequest, opts ...grpc.CallOption) (*CalculatorResponse, error)
}
...
func (c *calculatorServiceClient) Total(ctx context.Context, in *CalculatorRequest, opts ...grpc.CallOption) (*CalculatorResponse, error) {
	out := new(CalculatorResponse)
	err := c.cc.Invoke(ctx, "/calculator.CalculatorService/Total", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CalculatorServiceServer interface {
	Total(context.Context, *CalculatorRequest) (*CalculatorResponse, error)
}
...
func (*UnimplementedCalculatorServiceServer) Total(context.Context, *CalculatorRequest) (*CalculatorResponse, error) {
...
func _CalculatorService_Total_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CalculatorRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CalculatorServiceServer).Total(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/calculator.CalculatorService/Total",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CalculatorServiceServer).Total(ctx, req.(*CalculatorRequest))
	}
...
var _CalculatorService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Total",
			Handler:    _CalculatorService_Total_Handler,
		},
	},
